...
from facebook_sdk import settings as facebook_settings, signals
from facebook_sdk.exceptions import FacebookException
from facebook_sdk.utils import get_user_model, mass_get_or_create, \
...
try:
    ...
    from facebook_sdk.utils import parse_like_datetime as parse_date
...
class FacebookUserConverter(object):
    ...
    def _extract_url(cls, text_url_field):
        '''
        >>> from facebook_sdk.api import FacebookApi
        ...
        for part in parts:
            from facebook_sdk.utils import get_url_field
    ...
    def get_and_store_likes(self, user):
        ...
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from facebook_sdk.tasks import get_and_store_likes
    ...
    def store_likes(self, user, likes):
        ...
        '''
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from facebook_sdk.tasks import store_likes
    ...
    def _store_likes(self, user, likes):
        ...
        if likes:
            from facebook_sdk.models import FacebookLike
    ...
    def get_and_store_friends(self, user):
        ...
        '''
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from facebook_sdk.tasks import get_and_store_friends
    ...
    def store_friends(self, user, friends):
        ...
        '''
        if facebook_settings.FACEBOOK_CELERY_STORE:
            from facebook_sdk.tasks import store_friends
    ...
    def _store_friends(self, user, friends):
        from facebook_sdk.models import FacebookUser
