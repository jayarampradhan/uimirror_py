...
default_registration_backend = 'facebook_sdk.registration_backends.FacebookRegistrationBackend'
# : Allows you to overwrite the registration backend
# : Specify a full path to a class (defaults to facebook_sdk.registration_backends.FacebookRegistrationBackend)
...
FACEBOOK_CANVAS_PAGE = getattr(settings, 'FACEBOOK_CANVAS_PAGE',
                               'http://apps.facebook.com/facebook_sdk_test/')
...
default_registration_template = [
    'facebook_sdk/registration.html', 'registration/registration_form.html']
