...
from facebook_sdk.api import get_facebook_graph
from facebook_sdk.utils import get_registration_backend, get_form_class, \
...
def _register_user(request, facebook, profile_callback=None,
    ...
    new_user.backend = 'facebook_sdk.auth_backends.FacebookBackend'
