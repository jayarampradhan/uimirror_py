...
from facebook_sdk import admin

# putting this here instead of models.py reduces issues with import ordering
if getattr(settings, 'AUTH_PROFILE_MODULE', None) == 'facebook_sdk.FacebookProfile':
    '''
    ...
    from facebook_sdk.models import FacebookProfile
