...
from facebook_sdk.utils import get_user_model, is_user_attribute
...
class FacebookTest(TestCase):
    ...
    def setUp(self):
        from facebook_sdk.test_utils.mocks import MockFacebookAPI, MockFacebookAuthorization, RequestMock
        import sys
        import StringIO
    ...
    def mock_authenticated(self):
        ...
        self.create_patch('facebook_sdk.decorators.has_permissions', True)
        self.create_patch(
            'facebook_sdk.connect.get_facebook_graph', graph)
        self.create_patch(
            'facebook_sdk.decorators.get_persistent_graph', graph)
        self.create_patch(
            'facebook_sdk.decorators.require_persistent_graph', graph)
