...
from facebook_sdk.api import get_persistent_graph, require_persistent_graph
from facebook_sdk.decorators import facebook_required_lazy, facebook_required
from facebook_sdk.utils import next_redirect, parse_signed_request
...
def canvas(request, graph):
    ...
    return render_to_response('facebook_sdk/canvas.html', context)
...
def page_tab(request, graph):
    ...
    return render_to_response('facebook_sdk/page_tab.html', context)
