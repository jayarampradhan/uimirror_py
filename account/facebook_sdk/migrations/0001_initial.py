...
'''
from facebook_sdk.utils import get_migration_data
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'facebook_sdk_facebookuser', (
        ...
        db.send_create_signal(u'facebook_sdk', ['FacebookUser'])

        # Adding unique constraint on 'FacebookUser', fields ['user_id', 'facebook_id']
        db.create_unique(u'facebook_sdk_facebookuser', ['user_id', 'facebook_id'])

        # Adding model 'FacebookLike'
        db.create_table(u'facebook_sdk_facebooklike', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.IntegerField')()),
            ('facebook_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'facebook_sdk', ['FacebookLike'])

        # Adding unique constraint on 'FacebookLike', fields ['user_id', 'facebook_id']
        db.create_unique(u'facebook_sdk_facebooklike', ['user_id', 'facebook_id'])

        # Adding model 'FacebookProfile'
        db.create_table(u'facebook_sdk_facebookprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'facebook_sdk', ['FacebookProfile'])

        if getattr(settings, 'AUTH_USER_MODEL', None) == 'facebook_sdk.FacebookCustomUser':
            # Adding model 'FacebookCustomUser'
            db.create_table(u'facebook_sdk_facebookcustomuser', (
                (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            db.send_create_signal(u'facebook_sdk', ['FacebookCustomUser'])
    
            # Adding M2M table for field groups on 'FacebookCustomUser'
            m2m_table_name = db.shorten_name(u'facebook_sdk_facebookcustomuser_groups')
            db.create_table(m2m_table_name, (
                ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
                ('facebookcustomuser', models.ForeignKey(orm[u'facebook_sdk.facebookcustomuser'], null=False)),
            ...
            m2m_table_name = db.shorten_name(u'facebook_sdk_facebookcustomuser_user_permissions')
            db.create_table(m2m_table_name, (
                ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
                ('facebookcustomuser', models.ForeignKey(orm[u'facebook_sdk.facebookcustomuser'], null=False)),
        ...
        db.create_table('facebook_sdk_open_graph_share', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'facebook_sdk', ['OpenGraphShare'])


    def backwards(self, orm):
        # Removing unique constraint on 'FacebookLike', fields ['user_id', 'facebook_id']
        db.delete_unique(u'facebook_sdk_facebooklike', ['user_id', 'facebook_id'])

        # Removing unique constraint on 'FacebookUser', fields ['user_id', 'facebook_id']
        db.delete_unique(u'facebook_sdk_facebookuser', ['user_id', 'facebook_id'])

        # Deleting model 'FacebookUser'
        db.delete_table(u'facebook_sdk_facebookuser')

        # Deleting model 'FacebookLike'
        db.delete_table(u'facebook_sdk_facebooklike')

        # Deleting model 'FacebookProfile'
        db.delete_table(u'facebook_sdk_facebookprofile')

        # Deleting model 'FacebookCustomUser'
        db.delete_table(u'facebook_sdk_facebookcustomuser')

        # Removing M2M table for field groups on 'FacebookCustomUser'
        db.delete_table(db.shorten_name(u'facebook_sdk_facebookcustomuser_groups'))

        # Removing M2M table for field user_permissions on 'FacebookCustomUser'
        db.delete_table(db.shorten_name(u'facebook_sdk_facebookcustomuser_user_permissions'))

        # Deleting model 'OpenGraphShare'
        db.delete_table('facebook_sdk_open_graph_share')
    ...
    models = {
        ...
        u'facebook_sdk.facebookprofile': {
        ...
        u'facebook_sdk.opengraphshare': {
            'Meta': {'object_name': 'OpenGraphShare', 'db_table': "'facebook_sdk_open_graph_share'"},
