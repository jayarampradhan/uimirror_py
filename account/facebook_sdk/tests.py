...
from facebook_sdk import exceptions as facebook_exceptions, \
    settings as facebook_settings, signals
from facebook_sdk.api import get_facebook_graph, FacebookUserConverter, \
    get_persistent_graph
from facebook_sdk.auth_backends import FacebookBackend
from facebook_sdk.connect import _register_user, connect_user, \
    CONNECT_ACTIONS
from facebook_sdk.middleware import FacebookCanvasMiddleWare
from facebook_sdk.test_utils.mocks import RequestMock
from facebook_sdk.test_utils.testcases import FacebookTest, LiveFacebookTest
from facebook_sdk.utils import cleanup_oauth_url, get_profile_model, \
...
class BaseDecoratorTest(FacebookTest):
    ...
    def setUp(self):
        ...
        from facebook_sdk.decorators import facebook_required
...
class LazyDecoratorTest(DecoratorTest):
    ...
    def setUp(self):
        ...
        '''.replace(' ', '').replace('\n', '')
        self.target_url = target_url
        from facebook_sdk.decorators import facebook_required_lazy
...
class ConnectViewTest(FacebookTest):
    ...
    def test_connect(self):
        ...
        facebook_sdk.connect.connect_user
        '''
        ...
        with patch('facebook_sdk.views.connect_user', return_value=(CONNECT_ACTIONS.REGISTER, user)) as wrapped_connect:
            post_data = dict(
        ...
        # test login
        with patch('facebook_sdk.views.connect_user', return_value=(CONNECT_ACTIONS.LOGIN, user)) as wrapped_connect:
            post_data = dict(
                access_token='short_username',
        ...
        # test connect
        with patch('facebook_sdk.views.connect_user', return_value=(CONNECT_ACTIONS.CONNECT, user)) as wrapped_connect:
            post_data = dict(
                access_token='short_username',
                next='%s?loggggg=1' % example_url
            )
        ...
        with patch('facebook_sdk.views.connect_user', return_value=(CONNECT_ACTIONS.REGISTER, user), side_effect=profile_error) as wrapped_connect:
    ...
    def test_slow_connect(self):
        ...
        for error in errors:
            with patch('facebook_sdk.views.get_instance_for') as converter:
...
class UserConnectTest(FacebookTest):
    ...
    def test_parallel_register(self):
        ...
        with patch('facebook_sdk.connect.authenticate') as patched:
            ...
            with patch('facebook_sdk.connect._register_user') as patched_register:
    ...
    def test_registration_form(self):
        ...
        test_form = 'facebook_sdk.test_utils.forms.SignupForm'
...
class FacebookCanvasMiddlewareTest(FacebookTest):
    ...
    @patch('facebook_sdk.middleware.connect_user', fake_connect)
