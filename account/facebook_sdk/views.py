...
from facebook_sdk.connect import CONNECT_ACTIONS, connect_user
from facebook_sdk.decorators import facebook_required_lazy
from facebook_sdk.utils import next_redirect, get_registration_backend, \
...
def example(request):
    context = RequestContext(request)
    return render_to_response('facebook_sdk/example.html', context)
