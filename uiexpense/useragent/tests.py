...
class BaseTestCase(TestCase):
    ...
    def setUp(self):
        self.TEST_RESOURCES_DIR = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'test-resource')
        
class UserAgentTest(BaseTestCase):
    def testBrowserscopeStrings(self):
        self.runUserAgentTestsFromYAML(os.path.join(
            self.TEST_RESOURCES_DIR, 'test_user_agent_parser.yaml'))

    def testBrowserscopeStringsOS(self):
        self.runOSTestsFromYAML(os.path.join(
            self.TEST_RESOURCES_DIR, 'test_user_agent_parser_os.yaml'))

    def testStringsOS(self):
        self.runOSTestsFromYAML(os.path.join(
            self.TEST_RESOURCES_DIR, 'additional_os_tests.yaml'))

    def testStringsDevice(self):
        self.runDeviceTestsFromYAML(os.path.join(
            self.TEST_RESOURCES_DIR, 'test_device.yaml'))

    def testMozillaStrings(self):
        self.runUserAgentTestsFromYAML(os.path.join(
            self.TEST_RESOURCES_DIR, 'firefox_user_agent_strings.yaml'))
    ...
    def testPGTSStrings(self):
        self.runUserAgentTestsFromYAML(os.path.join(
            self.TEST_RESOURCES_DIR, 'pgts_browser_list.yaml'))
    ...
    def makePGTSComparisonYAML(self):
        ...
        yamlFile = open(os.path.join(self.TEST_RESOURCES_DIR,
    ...
    def runUserAgentTestsFromYAML(self, file_name):
        yamlFile = open(os.path.join(self.TEST_RESOURCES_DIR, file_name))
        yamlContents = yaml.load(yamlFile)
        yamlFile.close()
