...
(function ($) {
    ...
    var options = {
            ...
            minChar: 8,
            errorMessages: {
                password_to_short: gettext("The Password is too short"),
                same_as_username: gettext("Your password cannot be the same as your username")
            },
            scores: [17, 26, 40, 50],
            verdicts: [gettext("Weak"), gettext("Normal"), gettext("Medium"), gettext("Strong"), gettext("Perfect")],
            showVerdicts: true,
            raisePower: 1.4,
        ...
        setProgressBar = function ($el, score) {
            ...
            progressbar.addClass('showProgessBar');
            var _bar = progressbar.find(".progress-bar");
            if (score < options.scores[0]) {
            	_bar.addClass("progress-bar-danger").removeClass("progress-bar-warning").removeClass("progress-bar-success");
            	_bar.css("width", "5%");
                if (options.showVerdicts) {
            	...
            	_bar.addClass("progress-bar-warning").removeClass("progress-bar-danger").removeClass("progress-bar-success");
            	_bar.css("width", "50%");
                if (options.showVerdicts) {
            	...
            	_bar.addClass("progress-bar-success").removeClass("progress-bar-warning").removeClass("progress-bar-danger");
            	_bar.css("width", "100%");
                if (options.showVerdicts) {
    ...
    $.fn.uimpwstrength = function (method) {
        var result;
        if (methods[method]) {
